package cn.edu.gdmec.s07150834.intent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public  void  intentfilter(View v){
        String action ="cn.edu.gdmec.s07150834";
    ...
    protected void onActivityResult(int requerstCode,int resultCode,Intent data){
    switch (requerstCode){
        case 10:
        ...
        super.onActivityResult(requerstCode,resultCode,data);
    }
